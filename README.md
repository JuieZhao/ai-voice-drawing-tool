...
| 当前可见性 | 开发期 private，提交评审前/评审期按要求改为 public 或确保评委可访问 |
| Demo 视频 | 待录制后补充可访问链接 |
...
新增的绘图规划能力把“一句话画一个物体”拆成可解释步骤，例如“画一只小猫”会先生成头部、耳朵、眼睛、鼻子、胡须、身体和尾巴等动作；同时保留类似 Python 海龟绘图的逐步画笔控制，用户可以说“落笔、向前走一百、右转九十度”来一步步控制笔尖。
...
- 支持海龟式画笔控制：落笔、抬笔、前进、后退、左转、右转、回中心、改画笔颜色、改线宽
- 支持本地规划对象初版：小猫、小汽车
